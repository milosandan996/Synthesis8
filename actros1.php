...
<html>
    ...
    <body class="komatsu">
        ...
        <main style="background-image: url(../images/trucks/actros1back.jpg)" class="position-relative">

            <section class="section-table container">
                <h1 class="text-center">MERCEDES ACTROS - BG 1701 EK</h1>
                ...
                <table border="1" class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>X</td>
                            <td>X</td>
                            <td style="background-color: yellow"><b>Zamena disk pločica na svim osovinama na prikolici i na truku!!!</b></td>
                        </tr>
                    </tbody>
