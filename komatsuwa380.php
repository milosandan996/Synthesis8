...
<html>
    ...
    <body class="komatsu">
        ...
        <main style="background-image: url(../images/loaders/komatsu1.jpg)" class="position-relative">
            
            <section class="section-table container">
                <h1 class="text-center">KOMATSU WA380</h1>
